...
public class deliveryfulldetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnremoveuser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(deliveryfulldetails.this);
    ...
    private void deleteuser() {
        ...
        params.put("id",id);
        client.post(urls.removedeliveryboy,params,new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (status){
                        ...
                        Intent i = new Intent(deliveryfulldetails.this, AdminDeliveryboydataActivity.class);
                        startActivity(i);
                        Toast.makeText(deliveryfulldetails.this, "User data Remove From Database", Toast.LENGTH_SHORT).show();
                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(deliveryfulldetails.this, "Unable to remove data", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                Toast.makeText(deliveryfulldetails.this, "Server Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getdetails(String id) {
        ...
        client.post(urls.getdeliverydetils,params,new JsonHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                super.onSuccess(statusCode, headers, response);
                try {
                    JSONArray jsonArray = response.getJSONArray("getdeliverydetails");
                    for (int i =0;i<jsonArray.length();i++){
                       JSONObject jsonObject = jsonArray.getJSONObject(i);
                        ...
                        Glide.with(deliveryfulldetails.this)
