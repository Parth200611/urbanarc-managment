...
import com.example.urbanarc.Admin.deliveryfulldetails;
...
public class ADAPTERADminGETallDeliveryList extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.cvDeliverydatacard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(activity, deliveryfulldetails.class);
                i.putExtra("deliid",obj.getId());
